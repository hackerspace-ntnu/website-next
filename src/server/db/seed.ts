...
async function main() {
  ...
  const articleData: InsertNewsArticle[] = [
    {
      internal: true,
      titleNorwegian: 'Gruppestatus: Prosjekt spill',
      titleEnglish: 'Group status: Project Game',
      createdAt: faker.en.date.past(),
      views: faker.en.number.int({ min: 0, max: 10_000 }),
      contentNorwegian: faker.no.lorem.paragraphs(3),
      contentEnglish: faker.en.lorem.paragraphs(3),
      authorId: faker.en.number.int({ min: 1, max: usersData.length }),
    },
    {
      internal: false,
      titleNorwegian: 'DevOps-møtet',
      titleEnglish: 'DevOps Meeting',
      createdAt: faker.en.date.past(),
      views: faker.en.number.int({ min: 0, max: 10_000 }),
      contentNorwegian: faker.no.lorem.paragraphs(3),
      contentEnglish: faker.en.lorem.paragraphs(3),
    ...
    {
      internal: false,
      titleNorwegian: 'Jonas er kul',
      titleEnglish: 'Jonas is cool',
      createdAt: faker.en.date.past(),
      views: faker.en.number.int({ min: 0, max: 10_000 }),
      contentNorwegian: faker.no.lorem.paragraphs(3),
      contentEnglish: faker.en.lorem.paragraphs(3),
    ...
    {
      internal: true,
      titleNorwegian: 'Iskrem er godt',
      titleEnglish: 'Ice cream is good',
      createdAt: faker.en.date.past(),
      views: faker.en.number.int({ min: 0, max: 10_000 }),
      contentNorwegian: faker.no.lorem.paragraphs(3),
      contentEnglish: faker.en.lorem.paragraphs(3),
    ...
    {
      internal: false,
      titleNorwegian: 'Hvorfor er jeg her?',
      titleEnglish: 'Why am I here?',
      createdAt: faker.en.date.past(),
      views: faker.en.number.int({ min: 0, max: 10_000 }),
      contentNorwegian: faker.no.lorem.paragraphs(3),
      contentEnglish: faker.en.lorem.paragraphs(3),
    ...
    {
      internal: false,
      titleNorwegian: 'Dette er en veeeeldig lang overskrift som skal testes',
      titleEnglish: 'This is a veeeery long headline that should be tested',
      createdAt: faker.en.date.past(),
      views: faker.en.number.int({ min: 0, max: 10_000 }),
      contentNorwegian: faker.no.lorem.paragraphs(3),
      contentEnglish: faker.en.lorem.paragraphs(3),
    ...
    {
      internal: true,
      titleNorwegian: faker.no.lorem.sentence(),
      titleEnglish: faker.en.lorem.sentence(),
      createdAt: faker.en.date.past(),
      contentNorwegian: faker.no.lorem.paragraphs(3),
      contentEnglish: faker.en.lorem.paragraphs(3),
      authorId: faker.en.number.int({ min: 1, max: usersData.length }),
