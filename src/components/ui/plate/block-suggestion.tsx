...
import {
  discussionPlugin,
  type TDiscussion,
} from '@/components/ui/plate/kits/discussion-kit';
import { suggestionPlugin } from '@/components/ui/plate/kits/suggestion-kit';
          ...
          <div className='flex flex-col gap-2'>
                ...
                {suggestion.text &&
                  suggestionText2Array(suggestion.text).map((text) => (
                    ...
                    >
                      ...
                      <span key={suggestion.keyId} className='text-sm'>
                        {text}
                      </span>
                    </div>
                  ))}
            ...
            {suggestion.type === 'replace' && (
              <div className='flex flex-col gap-2'>
                {suggestion.newText &&
                  suggestionText2Array(suggestion.newText).map((text) => (
                    <React.Fragment key={suggestion.keyId}>
                      <div
                        key={suggestion.keyId}
