  ...
  return (
    ...
    <div
      ...
      onMouseEnter={() => {
        ...
        const newValue = calcDragButtonTop(editor, element);
        newValue && setDragButtonTop(newValue);
      }}
    >
      {!isInTable && (
        <Gutter>
      ...
      <div
        ref={previewRef}
        className={cx('-left-0 absolute hidden w-full')}
        style={{ top: `${-previewTop}px` }}
        contentEditable={false}
      />

      {/* biome-ignore lint/a11y/noStaticElementInteractions: Context Menu for all items */}
      <div
        ref={nodeRef}
  ...
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        {/* biome-ignore lint/a11y/useKeyWithClickEvents: Mouse is required for dragging */}
        {/* biome-ignore lint/a11y/useFocusableInteractive: Mouse is required for dragging */}
        <div
          ...
          onMouseEnter={() => {
            ...
            if (ids.length > 1 && ids.includes(element.id as string)) {
              ...
              previewTop && setPreviewTop(previewTop);
            } else {
              setPreviewTop(0);
            }
          }}
...
const calculatePreviewTop = (
  ...
  if (!child || !editable || !firstSelectedChild) return null;
