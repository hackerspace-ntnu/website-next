...
const comboboxItemVariants = cva({
  base: 'relative mx-1 flex h-[28px] select-none items-center rounded-sm px-2 text-foreground text-sm outline-none [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  defaultVariants: {
    interactive: true,
  },
  variants: {
...
const InlineComboboxItem = ({
  ...
  return (
    <ComboboxItem
      className={cx(comboboxItemVariants(), className)}
      onClick={(event) => {
...
const InlineComboboxEmpty = ({
  ...
  return (
    <div
      className={cx(comboboxItemVariants({ interactive: false }), className)}
    >
      {children}
    </div>
  );
