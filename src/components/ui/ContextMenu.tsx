...
function ContextMenu({
  ...props
}: React.ComponentPropsWithRef<typeof ContextMenuPrimitive.Root>) {
...
function ContextMenuPortal({
  ...props
}: React.ComponentPropsWithRef<typeof ContextMenuPrimitive.Portal>) {
  return (
...
function ContextMenuSub({
  ...props
}: React.ComponentPropsWithRef<typeof ContextMenuPrimitive.Sub>) {
  return <ContextMenuPrimitive.Sub data-slot='context-menu-sub' {...props} />;
}

function ContextMenuRadioGroup({
  ...props
}: React.ComponentPropsWithRef<typeof ContextMenuPrimitive.RadioGroup>) {
  return (
