...
function Header() {
  ...
  return (
    <header className='sticky top-0 z-20 flex min-h-14 w-full max-w-screen-2xl items-center justify-between border-b border-border/40 bg-background/95 px-4 backdrop-blur supports-[backdrop-filter]:bg-background/60 sm:px-11 md:px-16 lg:px-24'>
      <MobileSheet
